	...
	<section class="other-main">
		...
		<div class="other-programs">  
			<div class="other-inner">
				...
				<p>Humber’s User Experience (UX) Design graduate certificate simulates the interdisciplinary approaches needed to achieve an innovation process with a focus on design desirability, technological feasibility and business viability.</p>
				
			</div>
			<div class="other-inner">
				<h3>Web Design and Interactive Media</h3>
				<p>Interactive media is a constantly growing, multidisciplinary industry that combines creative and technical skills to build the tools we depend on every day.  These on-demand skills include visual design, coding, the ability to imagine what does not yet exist</p>
			
			</div>
		<div class="other-inner">
				<h3>Graphic Design for Print and Web</h3>
				<p>Motivated. Creative. Innovative. If these words describe you, then our intensive Graphic Design for Print and Web certificate program is for you. You will learn industry-best practices and how to communicate effective design solutions using composition, and web design.</p>
